...
$product_uom = ArrayHelper::map(Productuom::find()->all(), 'uomId', 'uomDesc');
$product_brand = ArrayHelper::map(ProductBrand::find()->all(), 'brandId', 'brandName');
$product_color = ArrayHelper::map(Productcolor::find()->all(), 'colorId', 'colorDesc');
?>
<div class="container">
   ...
   <?php $form = ActiveForm::begin(['id' => 'product-create'],[
        ...
        <div class="panel panel-primary setup-content" id="step-2">
            ...
            <div class="panel-body">
                ...
                <div class="row">
                <div class="col-sm-8">
                    <?= $form->field($model, 'uomId')->dropDownList($product_uom,['prompt'=>'Select unit of measurement'])->label(false) ?>
                </div> 
                <div class="col-sm-4">
                ...
                <div class="row">
                <div class="col-sm-8">
                    <?= $form->field($model, 'brandId')->dropDownList($product_brand,['prompt'=>'Select brand'])->label(false) ?>
                </div> 
                <div class="col-sm-4">
                ...
                <div class="row">
                <div class="col-sm-8">
                    <?= $form->field($model, 'colorId')->dropDownList($product_color,['prompt'=>'Select color'])->label(false) ?>
                </div> 
                <div class="col-sm-4">
...
<?php
Modal::begin([
  'title'=>'<h4>Add Unit of measurement</h4>',
  'id'=>'adduom',
  'size'=>'modal-lg'
  ]);
